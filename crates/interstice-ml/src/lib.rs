...
impl MLPipeline {
    ...
    fn convert_platform(&self, platform: &Platform) -> interstice_core::Platform {
        match platform {
            ...
            Platform::Linear => interstice_core::Platform::Jira,
            Platform::Discord => interstice_core::Platform::Slack,
            Platform::Confluence => interstice_core::Platform::Notion,
            Platform::GitLab => interstice_core::Platform::GitHub,
        }
    }
